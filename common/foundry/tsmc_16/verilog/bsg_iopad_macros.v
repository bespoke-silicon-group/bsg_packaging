...
`define BSG_OUTPUT_ENABLE(name)  ,.OE(name)
...
`define BSG_IO_IN_DISABLE(name,padtype)                                       \
  ...
  `BSG_IO_TIELO(name``_tlo)                                                   \
                                                                              \
                                                                              \
  padtype name``_i (.PAD(p_``name``_i), .OE(name``_oen_thi), .A(name``_tlo));
...
`define BSG_IO_IN(name,padtype)                            \
   ...
   wire name``_i_int;                                      \
                                                           \
   padtype name``_i (.PAD(p_``name``_i), .Y(name``_i_int));
...
`define BSG_IO_IN_A(pre,suffix,letter,index,padtype)                                                                \
                                                                                                                    \
   padtype pre``_``letter``_``suffix``_i (.PAD(p_``pre``_``suffix``_i[index]), .Y(pre``_``suffix``_i_int[index]));
...
`define BSG_IO_IN_V(name,index,padtype) padtype name``_``index``_i (.PAD(p_``name``_i[index]), .Y(name``_i_int[index]));



// **************************************************************************************************************
// PDT12DGZ foo_o (.PAD(p_foo_o), .OE(foo_oen_int), .I(foo_o_int))
...
`define BSG_IO_OUT(name,padtype)                                                                \
   ...
   `BSG_OUTPUT_ENABLE_WIRE(name``_oen_int)                                                       \
                                                                                                \
   padtype name``_o (.PAD(p_``name``_o) `BSG_OUTPUT_ENABLE(name``_oen_int) , .A(name``_o_int));
...
`define BSG_IO_OUT_V(name,index,padtype)                                                                                           \
                                                                                                                                   \
     padtype name``_``index``_o (.PAD(p_``name``_o[index])  `BSG_OUTPUT_ENABLE(name``_oen_int[``index]), .A(name``_o_int[``index]));
