...
(
  ...
  `define BSG_PINOUT_INVERTED_16B_CHANNEL_PORTS(ch_name) \
      output   p_``ch_name``_clk1_o  \
     ,output   p_``ch_name``_clk2_o  \
     ...
     ,input    p_``ch_name``_extra_i

  `define BSG_PINOUT_INVERTED_8B_CHANNEL_PORTS(ch_name) \
