...
- Orientation image
- Shape image
- Bond diagrams for signal/supply/vdd/v18/vss_vzz/inside/outside/all
...
- Run make (use -j8 to generate all images in parallel)
...
7. inside -- all bond pads on the inside of the chip
8. outside -- all bond pads on the outside of the chip
