...
`endif
  ...
  `BSG_IO_IN   (co_clk,  `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_IN   (co_v,    `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_OUT  (co_tkn,  `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(co_tkn_oen_int)
  `BSG_IO_IN   (co_0,    `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_IN   (co_1,    `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_IN   (co_2,    `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_IN   (co_3,    `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_IN   (co_4,    `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_IN   (co_5,    `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_IN   (co_6,    `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_IN   (co_7,    `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_IN   (co_8,    `BSG_PAD_INPUT_PULLDOWN)
  ...
  `BSG_IO_OUT  (ci2_clk,  `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_clk_oen_int)
  `BSG_IO_OUT  (ci2_v,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_v_oen_int)
  `BSG_IO_IN   (ci2_tkn,  `BSG_PAD_INPUT_PULLDOWN)
  `BSG_IO_OUT  (ci2_0,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_0_oen_int)
  `BSG_IO_OUT  (ci2_1,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_1_oen_int)
  `BSG_IO_OUT  (ci2_2,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_2_oen_int)
  `BSG_IO_OUT  (ci2_3,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_3_oen_int)
  `BSG_IO_OUT  (ci2_4,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_4_oen_int)
  `BSG_IO_OUT  (ci2_5,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_5_oen_int)
  `BSG_IO_OUT  (ci2_6,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_6_oen_int)
  `BSG_IO_OUT  (ci2_7,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_7_oen_int)
  `BSG_IO_OUT  (ci2_8,    `BSG_PAD_OUTPUT_SLOW)
  `BSG_IO_TIELO(ci2_8_oen_int)
