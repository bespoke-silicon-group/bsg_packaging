...
//   `BSG_IO_TIELO(misc_R_3_oen_int)
   ...
   `BSG_IO_IN (misc_T_0,`BSG_PAD_BIDIR_V)
   `BSG_IO_IN (misc_T_1,`BSG_PAD_BIDIR_V)
   `BSG_IO_IN (misc_T_2,`BSG_PAD_BIDIR_V)
...
//   `BSG_IO_TIELO(sdo_C_data_8_oen_int)
   ...
   // Lutag inputs
   `BSG_IO_IN(JTAG_TMS, `BSG_PAD_BIDIR_V)
   `BSG_IO_IN(JTAG_TDI, `BSG_PAD_BIDIR_V)
   `BSG_IO_IN(JTAG_TCK, `BSG_PAD_BIDIR_V)
   `BSG_IO_IN(JTAG_TRST,`BSG_PAD_BIDIR_V)
