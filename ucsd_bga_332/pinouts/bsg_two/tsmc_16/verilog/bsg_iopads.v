...
`endif
  ...
  //LDO DIGITAL SECTION
   ...
   //LDO ANALOG SECTION
  `BSG_ANALOG_PAD (LDO_VREFH, PANALOG_08_08_NT_DR_V)
  `BSG_ANALOG_PAD (LDO_VREFL, PANALOG_08_08_NT_DR_V)
  `BSG_ANALOG_PAD (LDO_VB_RING, PANALOG_08_08_NT_DR_V)
  `BSG_ANALOG_PAD (LDO_VCAL_HH, PANALOG_08_08_NT_DR_V)
  `BSG_ANALOG_PAD (LDO_VCAL_LL, PANALOG_08_08_NT_DR_V)
  `BSG_ANALOG_PAD (LDO_VL, PANALOG_08_08_NT_DR_V)
  `BSG_ANALOG_PAD (LDO_VDD_LOAD, PANALOG_08_08_NT_DR_V)
  `BSG_ANALOG_PAD (LDO_VDDIO, PANALOG_08_08_NT_DR_V)
  `BSG_ANALOG_PAD (LDO_VDDC, PANALOG_08_08_NT_DR_V)
  // Spare Analog Pins
