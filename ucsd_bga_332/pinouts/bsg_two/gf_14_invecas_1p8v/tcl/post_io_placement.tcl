...
set pll_tl_corner [lindex [get_attribute [get_cell BREAKER_B_0] boundary_bbox] 1]
set pll_br_corner [lindex [get_attribute [get_cell BREAKER_B_1] boundary_bbox] 0]
...
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_L_0"] ;# 0
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_L_1"] ;# 1
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_L_2"] ;# 2
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_L_3"] ;# 3
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_L_4"] ;# 4
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_L_5"] ;# 4
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_T_0"] ;# 6
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_T_1"] ;# 7
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_T_2"] ;# 8
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_T_3"] ;# 9
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_T_4"] ;# 10
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_T_5"] ;# 11
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_R_0"] ;# 12
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_R_1"] ;# 13
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_R_2"] ;# 14
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_R_3"] ;# 15
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_R_4"] ;# 16
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_R_5"] ;# 17
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_B_0"] ;# 18
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_B_1"] ;# 19
append_to_collection all_brk_cells [get_cells      "BREAKER_B_0"] ;# 20
append_to_collection all_brk_cells [get_cells      "BREAKER_B_1"] ;# 21
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_B_2"] ;# 22
append_to_collection all_brk_cells [get_cells "CTRL_BREAKER_B_3"] ;# 23
