...
set v33_pads_csv_filename     "v33_pads.csv"
...
set vdd_pads     [get_cells -hier "*VDD*_PAD"]
set v33_pads     [get_cells -hier "*V33*_PAD"]
set vss_vzz_pads [get_cells -hier "*VSS*_PAD *VZZ*_PAD"]

set supply_pads [list]
append_to_collection supply_pads $vdd_pads
append_to_collection supply_pads $v33_pads
...
set east_pads  [sort_collection             $east_pads   bounding_box.ll_y]
set south_pads [sort_collection             $south_pads  bounding_box.ll_x]
set west_pads  [sort_collection -descending $west_pads   bounding_box.ll_y]
set north_pads [sort_collection -descending $north_pads  bounding_box.ll_x]
...
dump_csv $v33_pads_csv_filename     $v33_pads
