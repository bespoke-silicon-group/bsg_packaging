...
`endif
   ...
   `BSG_IO_IN_ABCD (sdi,sclk,    `BSG_PAD_INPUT_PULLDOWN, `BSG_PAD_INPUT_PULLDOWN, `BSG_PAD_INPUT_PULLDOWN, `BSG_PAD_INPUT_PULLDOWN)
   //`BSG_IO_IN_ABCD (sdi,sclk_ex, `BSG_PAD_INPUT_PULLDOWN, `BSG_PAD_INPUT_PULLDOWN, `BSG_PAD_INPUT_PULLDOWN, `BSG_PAD_INPUT_PULLDOWN)
   `BSG_IO_IN_ABCD (sdi,ncmd,    `BSG_PAD_INPUT_PULLDOWN, `BSG_PAD_INPUT_PULLDOWN, `BSG_PAD_INPUT_PULLDOWN, `BSG_PAD_INPUT_PULLDOWN)
