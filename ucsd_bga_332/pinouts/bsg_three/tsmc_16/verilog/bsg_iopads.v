...
`endif
  ...
  // `BSG_ANALOG_PAD (LDO_SECTION_VDDOUT_LDO, PANALOG_08_08_NT_DR_V)

  wire VDDOUT_LDO;

  PANALOG_08_08_NT_DR_V LDO_SECTION_VDDOUT_LDO_i ( .RTO(1'b1), .SNS(1'b1),
        .PAD(p_LDO_SECTION_VDDOUT_LDO_i), .PADR1(VDDOUT_LDO)
         );
